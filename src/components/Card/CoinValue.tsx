...
const CoinValue = ({
  ...
  if (loading) {
    ...
    value = <p className="font-bold text-5xl text-red-500">ERROR</p>;
  } else {
    value = (
      <Tooltip
        size="lg"
      ...
      >
        <p className="font-bold text-5xl">{displayValue}</p>
      </Tooltip>
    );
  }
  ...
  return (
    <div className={`flex flex-row gap-2 mb-1 ${rowAlignment} items-center`}>
      {value}
